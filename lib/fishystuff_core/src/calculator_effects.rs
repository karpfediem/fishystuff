...
pub struct CalculatorEffectValues {
    pub afr: Option<f32>,
...
pub fn normalized_effect_lines(text: &str) -> Vec<String> {
    let mut out = Vec::new();
...
pub fn extract_first_number(text: &str) -> Option<f32> {
...
fn parse_calculator_effect_line(values: &mut CalculatorEffectValues, line: &str) {
...
#[cfg(test)]
fn parse_calculator_effect_text(values: &mut CalculatorEffectValues, text: &str) {
...
pub fn parse_unique_calculator_effect_text(values: &mut CalculatorEffectValues, text: &str) {
...
mod tests {
    ...
    fn calculator_effect_text_parses_balacs_style_lines() {
        let mut values = CalculatorEffectValues::default();
        ...
        assert_eq!(
            ...
            CalculatorEffectValues {
                afr: Some(0.07),
                exp_fish: Some(0.10),
                ..CalculatorEffectValues::default()
            }
        );
    }
    ...
    fn calculator_effect_text_parses_event_food_and_housekeeper_lines() {
        ...
        let mut event_food = CalculatorEffectValues::default();
        parse_calculator_effect_text(
            &mut event_food,
            "자동 낚시 시간 -10%\n생활 경험치 획득량 +50%\n생활 숙련도 +100",
        );
