...
pub struct Paths {
    ...
    pub zones_merged_csv: Option<String>,
...
fn assign_path(paths: &mut Paths, key: &str, value: &str) {
    match key {
        ...
        "zones_merged_csv" => paths.zones_merged_csv = Some(value.to_string()),
        ...
        "images_public_base_url" => paths.images_public_base_url = Some(value.to_string()),
