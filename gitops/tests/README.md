...
`gitops-beta-first-service-set-packet` filters the checked first-service-set plan down to only the current operator packet and no-mutation safety flags, including beta-runtime SecretSpec readiness when env files are the blocker.
