...
pkgs.testers.runNixOSTest {
  ...
  testScript = ''
    ...
    machine.wait_until_succeeds(f"jq -e '.desired_generation == 21 and .release_id == \"candidate-release\" and .site_root == \"/var/lib/fishystuff/gitops-test/served/local-test/site\" and .cdn_root == \"/var/lib/fishystuff/gitops-test/served/local-test/cdn\" and .state == \"selected_local_route\"' {route}")
