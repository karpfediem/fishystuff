...
pkgs.testers.runNixOSTest {
  ...
  testScript = ''
    ...
    machine.wait_until_succeeds(f"jq -e '.desired_generation == 30 and .release_id == \"candidate-release\" and .site_root == \"/var/lib/fishystuff/gitops-test/served/site\" and .cdn_root == \"/var/lib/fishystuff/gitops-test/served/cdn\" and .state == \"selected_local_route\"' {route}")
    ...
    machine.wait_until_succeeds(f"jq -e '.desired_generation == 31 and .release_id == \"previous-release\" and .site_root == \"/var/lib/fishystuff/gitops-test/served/site\" and .cdn_root == \"/var/lib/fishystuff/gitops-test/served/cdn\" and .state == \"selected_local_route\"' {route}")
