...
1. host-local bootstrap executor for the manually reviewed fresh-host contract
2. first real beta service start on the new service set using the service-start plan
