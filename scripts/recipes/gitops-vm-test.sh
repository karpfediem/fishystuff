...
case "$test_name" in
  ...
  generated-served-candidate)
    ...
    ;;
  production-vm-serve-fixture)
    check_attr="gitops-production-vm-serve-fixture-vm"
    ;;
  ...
  production-api-meta)
    ...
    ;;
  production-edge-handoff)
    check_attr="gitops-production-edge-handoff-vm"
    ;;
  ...
  local-apply-candidate)
    check_attr="gitops-local-apply-candidate-vm"
    ;;
  local-apply-fetch-pin)
    check_attr="gitops-local-apply-fetch-pin-vm"
    ;;
  local-apply-http-admission)
    check_attr="gitops-local-apply-http-admission-vm"
    ;;
