...
operator_current_hostname="$(deployment_current_hostname)"
operator_expected_hostname="$(deployment_resident_hostname beta)"
operator_expected_hostname_match="$(deployment_hostname_match_status "$operator_current_hostname" "$operator_expected_hostname")"
operator_resident_target="$(deployment_resident_target beta)"

printf 'operator_packet_status=%s\n' "$next_required_action"
printf 'operator_packet_current_hostname=%s\n' "$operator_current_hostname"
