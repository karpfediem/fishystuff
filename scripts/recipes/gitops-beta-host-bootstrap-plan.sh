...
printf 'required_directory_07_path=/var/lib/fishystuff/gitops-beta/tls/live\n'
...
printf 'read_only_readiness_check_03=just gitops-beta-deploy-credentials-packet\n'
printf 'read_only_readiness_check_04=just gitops-beta-host-provision-plan\n'
printf 'read_only_readiness_check_05=just gitops-beta-host-selection-packet public_ipv4=<new-beta-public-ip>\n'
printf 'read_only_readiness_check_06=just gitops-beta-service-bundles-test\n'
printf 'read_only_readiness_check_07=just gitops-beta-edge-handoff-bundle\n'
printf 'read_only_readiness_check_08=just gitops-beta-current-validate\n'
