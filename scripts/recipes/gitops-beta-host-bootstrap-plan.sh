...
printf 'read_only_readiness_check_05=just gitops-beta-service-bundles-test\n'
printf 'read_only_readiness_check_06=just gitops-beta-edge-handoff-bundle\n'
printf 'read_only_readiness_check_07=just gitops-beta-current-validate\n'
