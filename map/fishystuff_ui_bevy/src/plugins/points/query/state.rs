...
pub(in crate::plugins::points::query) struct PointsQuerySignature {
    ...
    pub(in crate::plugins::points::query) viewport_min_x: i32,
    pub(in crate::plugins::points::query) viewport_min_y: i32,
    pub(in crate::plugins::points::query) viewport_max_x: i32,
    pub(in crate::plugins::points::query) viewport_max_y: i32,
