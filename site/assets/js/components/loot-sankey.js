            ...
            if (provenanceSegmentHeight > 0.5) {
                ...
                provenanceSegments.forEach((segment, segmentIndex) => {
                    ...
                    provenanceRail.append("rect")
                        ...
                        .attr("data-fishy-provenance-source-kind", segment.sourceKind)
                        .attr("data-fishy-provenance-source-tone", segment.sourceTone)
                        .attr("data-fishy-provenance-source-icon", segment.sourceIcon)
