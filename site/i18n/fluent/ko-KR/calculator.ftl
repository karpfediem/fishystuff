...
calculator.server.action.drag_unpinned_slot = 고정되지 않은 슬롯 드래그
calculator.server.action.pin_dropzone_title = 여기에 놓아 고정
calculator.server.action.pin_dropzone_detail = 고정된 섹션은 선택한 탭 위에 계속 표시됩니다.
calculator.server.action.unpinned_dropzone_title = 여기에 놓아 고정되지 않은 슬롯 이동
calculator.server.action.unpinned_dropzone_detail = 앞으로 고정되지 않은 탭이 여기에 표시됩니다.
