...
calculator.breakdown.title.trade_distance_bonus = 거리 보너스
calculator.breakdown.title.trade_bargain_bonus = 흥정 보너스
calculator.breakdown.title.trade_sale_multiplier = 최종 판매 배수
calculator.breakdown.section.inputs = 입력값
calculator.breakdown.section.composition = 구성
calculator.breakdown.label.distance_bonus_used = 적용 거리 보너스
calculator.breakdown.summary.trade_distance_bonus = 선택한 판매 무역상 또는 직접 입력한 거리의 거리 보너스입니다.
calculator.breakdown.summary.trade_bargain_bonus = 선택한 무역 레벨에서 오는 흥정 보너스입니다.
calculator.breakdown.summary.trade_sale_multiplier = 거리, 흥정, 가격 곡선 설정을 적용한 최종 물고기 판매 배수입니다.
calculator.breakdown.formula.trade_distance_bonus = 적용 거리 보너스 = min(선택한 거리 보너스, 150%).
calculator.breakdown.formula.trade_bargain_bonus = 흥정 보너스 = 5% + 0.5% × 무역 레벨 인덱스.
calculator.breakdown.formula.trade_sale_multiplier = 최종 판매 배수 = (1 + min(거리 보너스, 150%)) × 무역 가격 곡선 × (1 + 흥정 보너스).
calculator.breakdown.detail.trade_destination_distance_bonus = 선택한 판매 무역상 또는 직접 입력한 거리의 거리 보너스입니다.
calculator.breakdown.detail.trade_distance_bonus_used = 판매 공식은 거리 보너스를 150%로 제한합니다.
calculator.breakdown.detail.trade_level_selected = 선택한 무역 레벨입니다.
calculator.breakdown.detail.trade_level_bargain_bonus = 선택한 무역 레벨에서 계산된 흥정 보너스입니다.
calculator.breakdown.detail.trade_sale_distance_bonus = 판매 공식의 150% 제한을 적용한 거리 보너스입니다.
calculator.breakdown.detail.trade_sale_price_curve = 판매 배수에 반영되는 무역 가격 곡선 비율입니다.
calculator.breakdown.detail.trade_sale_bargain_bonus = 판매 배수에 반영되는 흥정 보너스입니다.
calculator.breakdown.detail.trade_sale_multiplier_result = 현재 물고기 판매 가격에 적용되는 최종 배수입니다.

calculator.server.option.none = 없음
calculator.server.option.custom_trade_distance = 사용자 지정 거리 보너스
...
calculator.server.search.trade_origins = 무역 원산지 검색
calculator.server.search.trade_destinations = NPC, 지역 또는 거리 %
...
calculator.server.field.trade_origin = 무역 원산지
calculator.server.field.trade_destination = 판매 무역상
...
calculator.server.stat.expected_exp = 예상 경험치
calculator.server.stat.exp_per_hour = 시간당 경험치
calculator.server.stat.bargain_bonus = 흥정 보너스
calculator.server.stat.sale_multiplier = 최종 판매 배수
...
calculator.server.helper.custom_trade_distance = 수동 거리 보너스
...
calculator.server.tab.value_split = 가치 분할
calculator.server.tab.silver = 은화
calculator.server.tab.exp = 경험치
calculator.server.tab.loot_flow = 전리품 흐름
calculator.server.tab.exp_flow = 경험치 흐름
...
calculator.server.grade.prize = 보물
calculator.server.grade.rare = 노란색
calculator.server.grade.high_quality = 파란색
calculator.server.grade.general = 녹색
calculator.server.grade.trash = 흰색
...
calculator.server.chart.no_exp_rows = 이 지역에는 아직 소스 기반 물고기 경험치 행이 없습니다.
...
calculator.server.chart.exp_flow_title = 경험치 흐름
calculator.server.chart.exp_flow_description = 각 흐름은 물고기 그룹에서 시작해 소스 기반 종 행을 거친 뒤 경험치 가중 그룹 합계로 다시 합쳐집니다. 왼쪽 지표는 드롭률 구성을, 오른쪽 지표는 경험치 기여도를 보여줍니다.
...
calculator.server.chart.group_exp_distribution_title = 그룹 경험치 분포
calculator.server.chart.group_exp_distribution_description = 소스 기반 물고기 경험치 값과 활성 경험치 보정을 적용한 물고기 그룹별 예상 경험치 비중입니다.
calculator.server.chart.aria.group_distribution = 그룹 드롭률 분포
calculator.server.chart.aria.group_silver_distribution = 그룹 은화 분포
calculator.server.chart.aria.group_exp_distribution = 그룹 경험치 분포
calculator.server.chart.aria.loot_flow = 그룹에서 전리품 행으로 이어지는 예상 전리품 흐름
calculator.server.chart.aria.exp_flow = 그룹에서 전리품 행으로 이어지는 예상 경험치 흐름
...
calculator.server.chart.aria.value_split_metric_switch = 가치 분할 지표
calculator.server.chart.aria.loot_flow_metric_switch = 전리품 흐름 지표
calculator.server.chart.aria.workspace_tabs = 계산기 섹션
calculator.server.chart.aria.custom_tabs = Custom 작업공간 카드

calculator.server.badge.zone_origin = 지역 원산지

calculator.server.group.harpoon = 작살
calculator.server.zone_loot_summary.title = 지역 어획 프로필 그룹
calculator.server.zone_loot.method.fishing = 낚시
calculator.server.zone_loot.method.harpoon = 작살
calculator.server.zone_loot.method_note.fishing = 낚싯대 기반 지역 그룹과 그룹 내 종 비율입니다.
calculator.server.zone_loot.method_note.harpoon = 작살 전용 지역 그룹과 그룹 내 종 비율입니다.
calculator.server.zone_loot.conditions = 조건
calculator.server.zone_loot.empty_group = 이 그룹에는 현재 소스 기반 종 항목이 배정되어 있지 않습니다.
...
calculator.breakdown.title.loot_total_totem_exp = 예상 토템 경험치 ({$timespan})
calculator.breakdown.title.loot_totem_exp_per_hour = 시간당 토템 경험치
calculator.breakdown.label.expected_totem_exp = 예상 토템 경험치
calculator.breakdown.label.expected_totem_exp_for_timespan = 예상 토템 경험치 ({$timespan})
calculator.breakdown.label.group_expected_totem_exp = 그룹 예상 토템 경험치
calculator.breakdown.label.group_totem_exp = 그룹 토템 경험치
calculator.breakdown.label.totem_exp_per_hour = 시간당 토템 경험치
calculator.breakdown.label.totem_exp_share = 토템 경험치 비중
calculator.breakdown.summary.loot_total_totem_exp = 현재 세션 시간 동안 유지되는 소스 기반 또는 등급 규칙 추정 물고기 획득에서 얻는 예상 토템 경험치입니다.
calculator.breakdown.summary.loot_totem_exp_per_hour = 유지되는 소스 기반 또는 등급 규칙 추정 물고기 획득에서 얻는 시간당 토템 경험치입니다.
calculator.breakdown.formula.loot_total_totem_exp = 예상 토템 경험치 = Σ(그룹 예상 토템 경험치).
calculator.breakdown.formula.loot_totem_exp_per_hour = 시간당 토템 경험치 = 예상 토템 경험치 / 세션 시간.
calculator.breakdown.detail.expected_totem_exp_selected_session = 선택한 세션 시간 동안의 예상 토템 경험치입니다.
calculator.breakdown.detail.expected_totem_exp_current_session = 현재 세션 시간 동안의 예상 토템 경험치입니다.
calculator.breakdown.detail.expected_hourly_totem_exp_throughput = 시간당 예상 토템 경험치입니다.
calculator.breakdown.detail.no_source_backed_loot_rows_contributing_expected_totem_exp = 현재 소스 기반 또는 등급 규칙 추정 토템 경험치로 기여하는 유지된 물고기 행이 없습니다.
calculator.breakdown.detail.group_expected_totem_exp_share = 예상 토템 경험치의 {$share}

calculator.server.stat.expected_totem_exp = 예상 토템 경험치
calculator.server.stat.totem_exp_per_hour = 시간당 토템 경험치
calculator.server.tab.totem_exp = 토템 경험치
calculator.server.tab.totem_exp_flow = 토템 경험치 흐름
calculator.server.chart.no_totem_exp_rows = 이 지역에는 현재 소스 기반 또는 등급 규칙 추정 토템 경험치로 기여하는 유지된 물고기 행이 없습니다.
calculator.server.chart.totem_exp_flow_title = 토템 경험치 흐름
calculator.server.chart.totem_exp_flow_description = 각 흐름은 물고기 그룹에서 시작해 유지되는 물고기 행을 거친 뒤 토템 경험치 가중 그룹 합계로 다시 합쳐집니다. 출처 막대는 소스 기반 값과 등급 규칙 추정 값을 표시합니다.
calculator.server.chart.group_totem_exp_distribution_title = 그룹 토템 경험치 분포
calculator.server.chart.group_totem_exp_distribution_description = 유지되는 소스 기반 또는 등급 규칙 추정 물고기 획득에서 얻는 물고기 그룹별 예상 토템 경험치 비중입니다.
calculator.server.chart.aria.group_totem_exp_distribution = 그룹 토템 경험치 분포
calculator.server.chart.aria.totem_exp_flow = 그룹에서 전리품 행으로 이어지는 예상 토템 경험치 흐름

calculator.server.loot.breakdown.title.species_totem_exp_share = {$species} 토템 경험치 비중
calculator.server.loot.breakdown.title.group_totem_exp_share = {$group} 토템 경험치 비중
calculator.server.loot.breakdown.formula.species_totem_exp_share = 아이템 예상 토템 경험치 = 예상 획득 수 × 유지된 물고기의 기본 토템 경험치.; 토템 경험치 비중 = 아이템 예상 토템 경험치 / 전체 아이템 예상 토템 경험치.
calculator.server.loot.breakdown.formula.group_totem_exp_share = 토템 경험치 비중 = 그룹 예상 토템 경험치 / 전체 그룹 예상 토템 경험치.
calculator.server.loot.breakdown.label.base_totem_exp = 기본 토템 경험치
calculator.server.loot.breakdown.label.item_expected_totem_exp = 아이템 예상 토템 경험치
calculator.server.loot.breakdown.label.all_item_expected_totem_exp_total = 전체 아이템 예상 토템 경험치
calculator.server.loot.breakdown.label.all_group_expected_totem_exp_total = 전체 그룹 예상 토템 경험치
calculator.server.loot.breakdown.summary.species_totem_exp_share.active = 이 유지된 물고기 행의 예상 토템 경험치 기여도입니다.
calculator.server.loot.breakdown.summary.species_totem_exp_share.none = 이 전리품 행은 현재 소스, 추정 및 버리기 설정에서 예상 토템 경험치에 기여하지 않습니다.
calculator.server.loot.breakdown.summary.group_totem_exp_share.active = 이 그룹에 매핑된 유지 물고기 행의 예상 토템 경험치 비중입니다.
calculator.server.loot.breakdown.summary.group_totem_exp_share.none = 이 그룹은 현재 소스, 추정 및 버리기 설정에서 예상 토템 경험치에 기여하지 않습니다.
calculator.server.loot.breakdown.detail.zero_exp_after_source = 현재 소스 설정 후 0 경험치
calculator.server.loot.breakdown.detail.zero_totem_exp_after_source = 현재 소스 및 추정 설정 후 0 토템 경험치
calculator.server.loot.breakdown.detail.base_totem_exp = 유지된 물고기 획득 1회에 대한 기본 토템 경험치입니다.
calculator.server.loot.breakdown.detail.totem_exp_share.discarded = 버린 물고기는 토템 경험치를 주지 않습니다.
calculator.server.loot.breakdown.detail.totem_exp_share.no_source_exp = 이 아이템에 사용할 소스 기반 또는 등급 규칙 추정 토템 경험치 값이 없어 현재 0입니다.
calculator.server.loot.breakdown.detail.totem_exp_share.expected_exp = 예상 유지 획득 수에 기본 토템 경험치를 곱한 값입니다.
calculator.server.loot.breakdown.detail.all_item_expected_totem_exp_total = 토템 경험치 흐름의 아이템 비중 분포에 쓰이는 분모입니다.
calculator.server.loot.breakdown.detail.totem_exp_share.from_total = 아이템 예상 토템 경험치를 전체 예상 토템 경험치로 나누어 계산합니다.
calculator.server.loot.breakdown.detail.contributing_loot_totem_exp.unavailable = 현재 이 그룹에 토템 경험치를 기여하는 소스 기반 또는 등급 규칙 추정 유지 물고기 행이 없습니다.
calculator.server.loot.breakdown.detail.group_expected_totem_exp = 소스 기반 또는 등급 규칙 추정 토템 경험치 값을 적용한 유지 기여 물고기 행의 합계입니다.
calculator.server.loot.breakdown.detail.all_group_expected_totem_exp_total = 토템 경험치 비중 분포의 분모입니다.
calculator.server.loot.breakdown.detail.group_totem_exp_share_from_total = 그룹 예상 토템 경험치를 전체 예상 토템 경험치로 나누어 계산합니다.
calculator.server.provenance.metric.totem_exp = 토템 경험치
calculator.server.loot.totem_exp_source.source_backed = fish_size (flock) Encyclopedia_Table (2021)의 소스 기반 %FishExpRate입니다.
calculator.server.loot.totem_exp_source.imputed_grade_rule = 소스 기반 토템 경험치 행이 없어 등급 규칙으로 추정했습니다({$grade}: {$exp} EXP). 녹색은 소스 기반 녹색 행이 625와 1250으로 나뉘므로 보수적으로 625를 사용합니다.
calculator.server.loot.totem_exp_source.non_fish = 물고기만 토템 경험치를 줍니다.
calculator.server.loot.totem_exp_source.none = 사용할 수 있는 소스 기반 또는 등급 규칙 토템 경험치 값이 없습니다.
calculator.server.loot.totem_exp_source.group_source_backed = 이 그룹의 모든 토템 경험치 값은 소스 기반 %FishExpRate 행입니다.
calculator.server.loot.totem_exp_source.group_imputed = 이 그룹의 모든 토템 경험치 값은 등급 규칙으로 추정되었습니다.
calculator.server.loot.totem_exp_source.group_mixed = 토템 경험치는 소스 기반 %FishExpRate 행과 등급 규칙 추정을 함께 사용합니다(소스 기반 {$sourceBacked}개, 추정 {$imputed}개).
