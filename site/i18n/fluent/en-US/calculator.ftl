...
calculator.breakdown.detail.trade_destination_distance_bonus = Distance bonus from the selected sale trader, or the typed custom distance.
calculator.breakdown.detail.trade_distance_bonus_used = The sale formula caps distance bonus at 150%.
calculator.breakdown.detail.trade_level_selected = Selected trade level.
calculator.breakdown.detail.trade_level_bargain_bonus = Bargain bonus derived from the selected trade level.
calculator.breakdown.detail.trade_sale_distance_bonus = Distance bonus after the 150% sale-formula cap.
calculator.breakdown.detail.trade_sale_price_curve = Trade price curve percent converted into the sale multiplier.
calculator.breakdown.detail.trade_sale_bargain_bonus = Bargain bonus converted into the sale multiplier.
calculator.breakdown.detail.trade_sale_multiplier_result = Final multiplier currently applied to fish sale value.
...
calculator.server.option.custom_trade_distance = Custom distance
...
calculator.server.workspace.basics = Basics
calculator.server.workspace.loadout = Loadout
calculator.server.workspace.loot = Loot
calculator.server.workspace.trade = Trade
calculator.server.workspace.advanced = Advanced
...
calculator.server.search.trade_origins = Search trade origins
calculator.server.search.trade_destinations = NPC, region, or distance %
...
calculator.server.field.trade_origin = Trade Origin
calculator.server.field.trade_destination = Destination Trader
...
calculator.server.helper.custom_trade_distance = Manual distance bonus
...
calculator.server.tab.value_split = Value Split
...
calculator.server.chart.aria.value_split_metric_switch = Value Split metric
calculator.server.chart.aria.loot_flow_metric_switch = Loot Flow metric
calculator.server.chart.aria.workspace_tabs = Calculator sections
calculator.server.chart.aria.custom_tabs = Custom workspace cards
...
calculator.server.badge.zone_origin = Zone origin
...
calculator.server.group.tooltip.source_backed_share = DB {$group} group share
...
calculator.server.loot.totem_exp_source.non_fish = Only fish give Totem EXP.
...
calculator.server.zone_loot_summary.note.presence = Rows with unresolved group share or drop-rate support stay visible in the list until their structure is filled in.
calculator.server.zone_loot_summary.note.default = Groups follow the current calculator ordering, and rows show each fish or item's in-group droprate.
