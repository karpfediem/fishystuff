...
const iconSources = {
  ...
  "information-fill": { type: "mingcute", name: "information-fill" },
  "alert-fill": { type: "mingcute", name: "alert-fill" },
  "alert-triangle": { type: "mingcute", name: "alert-fill" },
  "arrows-up-fill": { type: "mingcute", name: "arrows-up-fill" },
  "bug-fill": { type: "mingcute", name: "bug-fill" },
  ...
  "fullscreen-fill": { type: "mingcute", name: "fullscreen-fill" },
  "map-view": { type: "mingcute", name: "map-fill" },
  "trending-up-fill": { type: "mingcute", name: "trending-up-fill" },
  "wheel-fill": { type: "mingcute", name: "wheel-fill" },
  ...
  "ring-partial": { type: "mingcute", name: "quarter-circle-dash-fill" },
  ...
  "check-circle-dash-line": { type: "mingcute", name: "check-circle-dash-line" },
