...
const iconSources = {
  ...
  "nav-calculator": { type: "mingcute", name: "formula-fill" },
  "nav-community": { type: "mingcute", name: "group-3-fill" },
  "nav-log": { type: "mingcute", name: "notebook-fill" },
  "adjustments-horizontal": { type: "mingcute", name: "settings-3-fill" },
  "information-circle": { type: "mingcute", name: "information-fill" },
  "squares-2x2": { type: "mingcute", name: "grid-fill" },
