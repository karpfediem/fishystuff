        ...
        let
          ...
          gitopsTests = import ./gitops/tests/nixos {
            ...
            productionServeFixture = {
              desiredState = gitopsDesiredStateProductionVmServeFixture;
          ...
          cdnServingRootRetentionCheck =
            let
              ...
              previousFixture = pkgs.runCommand "cdn-serving-previous-fixture" { } ''
                ...
                printf 'old-runtime-br' > "$out/map/fishystuff_ui_bevy.old.js.br"
            ...
            pkgs.runCommand "cdn-serving-root-retention-check" { nativeBuildInputs = [ pkgs.jq ]; } ''
              ...
              test "$(cat ${servingRoot}/map/fishystuff_ui_bevy.old.js.br)" = "old-runtime-br"
