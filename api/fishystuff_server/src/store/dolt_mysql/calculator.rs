...
fn build_source_consumable_item(
    lang: FishLang,
    item_id: i32,
...
fn build_source_lightstone_item(
    lang: FishLang,
    legacy: &CalculatorItemEntry,
    name_ko: Option<&str>,
    override_values: CalculatorItemEffectValues,
...
mod tests {
    ...
    use super::{
        build_source_consumable_item, build_source_lightstone_item, calculator_pet_option_label,
        canonical_pet_option_key, CalculatorItemSourceMetadata,
    };
